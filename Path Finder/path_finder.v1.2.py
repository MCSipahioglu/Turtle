...
def calculate(f_wid, f_len, c_wid, c_len, c_num, orient, data_ps):
    ...
    outF.writelines(str(needed1)+"\n")
    outF.writelines(str(needed2)+"\n")
    outF.writelines(str(needed3)+"\n")
    outF.writelines(str(needed4)+"\n")
    outF.writelines(str(needed5)+"\n")
    outF.close()
...
label0 = tk.Label(form,
                  text="Please rotate your field sketch until enter point of the robot is near to the left bottom",
                  font='Times 14 bold')
